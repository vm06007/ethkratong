                    ...
                    <div className="flex flex-col overflow-y-auto">
                        <div className="px-4 py-4 space-y-4">
                            <div>
                                ...
                                <select
                                    className="w-full border rounded-lg px-3 py-2 text-sm border-gray-300 bg-gray-50 text-gray-900 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                            ...
                            <div className="space-y-2">
                                ...
                                {data.uniswapVersionAuto !== false ? (
                                    ...
                                    <select
                                        ...
                                        className="w-full border rounded-lg px-3 py-2 text-sm mt-1 border-gray-300 bg-gray-50 text-gray-900 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                                    >
                            ...
                            {isSwap ? (
                                <>
                                    ...
                                    {data.swapFrom && data.swapTo && data.amount?.trim() && (
                                        <div className="rounded-xl border p-4 bg-gray-100 border-gray-300 dark:bg-gray-800/80 dark:border-gray-700">
                                    ...
                                    {/* Expandable details */}
                                    <div className="rounded-xl border overflow-hidden border-gray-300 dark:border-gray-700">
                                        <button
                                            type="button"
                                            className="w-full flex items-center justify-between px-4 py-3 text-left text-sm font-medium bg-gray-50 hover:bg-gray-100 text-gray-700 dark:bg-gray-800/50 dark:hover:bg-gray-800 dark:text-gray-300"
                                        ...
                                        {showDetails && (
                                            <div className="px-4 py-3 space-y-3 border-t bg-gray-50 border-gray-300 dark:bg-gray-800/30 dark:border-gray-700">
                                                {rateText && (
                                                ...
                                                <div className="flex justify-between items-center text-sm">
                                                    ...
                                                    <span className="text-violet-600 dark:text-violet-400">Free</span>
                                                </div>
                                                <div className="flex justify-between items-center text-sm">
                                                    <span className="flex items-center gap-1.5 text-gray-600 dark:text-gray-400">
                                                        Network cost
